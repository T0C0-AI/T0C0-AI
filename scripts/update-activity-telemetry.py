...
def generate_section(total, reviews, total_all_time, range_label):
    ...
    return (
        ...
        f'\n'
        f'![](./assets/activity-telemetry.svg#gh-light-mode-only)\n'
        f'![](./assets/activity-telemetry-dark.svg#gh-dark-mode-only)\n'
        f'\n'
        f'</td>\n'
        f'<td align="center" valign="top">\n'
        f'\n'
        f'![](./assets/overall-activity.svg#gh-light-mode-only)\n'
        f'![](./assets/overall-activity-dark.svg#gh-dark-mode-only)\n'
        f'\n'
        f'</td>\n'
        f'</tr></table>\n'
        f"\n"
