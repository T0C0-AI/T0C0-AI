...
def generate_section(periods, total, reviews):
    ...
    return (
        ...
        f'<div align="center">\n'
        f"\n"
        f"<h3>\U0001f554 Operator Activity Telemetry</h3>\n"
        f"\n"
        f'<img src="https://img.shields.io/badge/Weekly_Commits-{total}-bd00ff?style=for-the-badge&logo=github&logoColor=white" />\n'
        f'<img src="https://img.shields.io/badge/Code_Reviews-{reviews}-06b6d4?style=for-the-badge&logo=codereview&logoColor=white" />\n'
        f"\n"
        f"<br><br>\n"
        f"\n"
        ...
        f"<br>\n"
        f"\n"
        f"<sub>Last updated: {now_utc} \u00b7 Auto-generated by GitHub Actions</sub>\n"
        f"\n"
        f"</div>\n"
        f"\n"
        f"{END_MARKER}"
